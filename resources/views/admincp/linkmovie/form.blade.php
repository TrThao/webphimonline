...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                      <a href="{{route('linkmovie.index')}}" class="btn btn-primary">Liệt kê Link Movie</a>
                    <div class="card-header">{{ __('Quản Lý link movie') }}</div>
                    @if ($errors->any())
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('status', ['1' => 'Hiển Thị', '0' => 'Ẩn'], isset($linkmovie) ? $linkmovie->status : '', [
                                'class' => 'form-control',
                            ]) !!}
                        </div>
                        @if (!isset($linkmovie))
