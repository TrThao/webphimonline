...
@section('content_login')
 <div id="logreg-forms">
         <form method="POST" action="{{ route('login') }}">
            @csrf
            <h1 class="h3 mb-3 font-weight-normal" style="text-align: center"> Đăng nhập quản trị</h1>
            ...
            <div class="row mb-12">
                            ...
                            <div class="col-md-8">
                                <input id="email" type="email" placeholder="Nhập vào email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="password" type="password" placeholder="Nhập vào password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
