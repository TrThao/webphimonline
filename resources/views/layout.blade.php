...
<head>
    ...
    <style type="text/css" id="wp-custom-css">
        ...
        .input-group input {
            ...
            /* Có thể thay đổi giá trị này tùy thuộc vào ý muốn của bạn */
        }
            ...
            <div class="row" id="headwrap">
                <div class="col-md-3 col-sm-6 slogan">
                    <p class=""><a class="logo" href="/" title="phim hay ">
                            ...
                            <img style="width: 253px;height: 65px;" src="{{ asset('uploads/logo/' . $info->logo) }}">
                    </p>
                    </a>
                </div>
    ...
    <footer id="footer" class="clearfix">
        <div class="container footer-columns">
            <div class="row container">
                ...
                <div class="widget about col-xs-12 col-sm-4 col-md-9">
                    <div class="footer-logo">
